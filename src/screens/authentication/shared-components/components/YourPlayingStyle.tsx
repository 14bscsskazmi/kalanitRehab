...
const PlayingStyle: FunctionComponent = (props) => {
  ...
  return(
    <View style={styles}>
      <Text style={[globalStyles.regular, styles.your_styles_text]}>Your Style</Text>
      <View style={styles.playing_style_horizontal_view}>
        <TouchableOpacity
          style={[styles.left_handed, {backgroundColor: handStyle === 0 ? COLORS.medium_dark_blue : COLORS.dark_black}]}
          onPress={() => {
            setHandStyle(0);
          }}
        >
        ...
        <TouchableOpacity
          style={[styles.right_handed, {backgroundColor: handStyle === 1 ? COLORS.medium_dark_blue : COLORS.dark_black}]}
          onPress={() => {
            setHandStyle(1);
          }}
        >
